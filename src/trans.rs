                        ...
                        match *destination {
                            Some((ref lvalue, _)) => {
                                ...
                                if b_fnty == BinaryenNone() {
                                    ...
                                    debug!("emitting {:?} Call to fn {:?} + SetLocal({}) for unit type", call_kind, func, lvalue.index.0);
                                    ...
                                    debug!("emitting {:?} Call to fn {:?} + SetLocal({}) of the result", call_kind, func, lvalue.index.0);
