...
#[macro_use]
pub mod num; // stack overflow (si on commente pas une partie), sinon ICE sur Option.unwrap_or_else
...
// pub mod hash;
// // pub mod fmt; // stack overflow, a l'air de necessiter les traits avec vtable
